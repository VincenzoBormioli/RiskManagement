/* checksum : a58cffeee1f65dda9010fa2e1655b160 */
@cds.external : true
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {
  ...
  @sap.label : 'Correspnc. Ext. Ref.'
  @sap.quickinfo : 'Correspondence External Reference'
  CorrespncExternalReference : String(12);
  @sap.label : 'Pur. Order Ext. Ref.'
  @sap.quickinfo : 'Purchase Order Correspondence External Reference'
  POCorrespncExternalReference : String(12);
  @sap.display.format : 'UpperCase'
  ...
  to_BillingPlan : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderBillingPlan {  };
  ...
  to_PrecedingProcFlowDoc : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderPrecdgProcFlow {  };
  ...
  to_SubsequentProcFlowDoc : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderSubsqntProcFlow {  };
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderBillingPlan {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  to_BillingPlanItem : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderBillingPlanItem {  };
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderBillingPlanItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderHeaderPartner {
  ...
  to_Address : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderPartnerAddress {  };
  to_SalesOrder : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {  };
};
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItem {
  ...
  to_BillingPlan : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemBillingPlan {  };
  to_Partner : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemPartner {  };
  to_PrecedingProcFlowDocItem : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItmPrecdgProcFlow {  };
  ...
  to_SubsequentProcFlowDocItem : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItmSubsqntProcFlow {  };
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemBillingPlan {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @sap.updatable : 'false'
  BillingPlanSearchTerm : String(10);
  to_BillingPlanItem : Association to many OP_API_SALES_ORDER_SRV_0001.A_SlsOrderItemBillingPlanItem {  };
  to_SalesOrder : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {  };
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemPartner {
  ...
  @sap.quickinfo : 'VAT Registration Number'
  VATRegistration : String(20);
  to_Address : Association to many OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemPartnerAddress {  };
  to_SalesOrder : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {  };
  to_SalesOrderItem : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItem {  };
};
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemPartnerAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_Partner : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItemPartner {  };
  to_SalesOrder : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {  };
  to_SalesOrderItem : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItem {  };
};
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItmPrecdgProcFlow {
  @sap.display.format : 'UpperCase'
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderItmSubsqntProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Preceding Document'
  @sap.quickinfo : 'Preceding sales and distribution document'
  key SalesOrder : String(10) not null;
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'SD Document'
  @sap.quickinfo : 'Sales and Distribution Document Number'
  key SalesOrder : String(10) not null;
  ...
  @sap.quickinfo : 'Fax no.: Extension'
  FaxExtensionNumber : String(10);
  to_Partner : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrderHeaderPartner {  };
  to_SalesOrder : Association to OP_API_SALES_ORDER_SRV_0001.A_SalesOrder {  };
};
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderPrecdgProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Subsequent Document'
  @sap.quickinfo : 'Subsequent Sales and Distribution Document'
  key SalesOrder : String(10) not null;
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderSubsqntProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Preceding Document'
  @sap.quickinfo : 'Preceding sales and distribution document'
  key SalesOrder : String(10) not null;
...
entity OP_API_SALES_ORDER_SRV_0001.A_SalesOrderValAddedSrvc {
  ...
  @sap.sortable : 'false'
  @sap.filterable : 'false'
  ValueAddedServiceLongText : LargeString;
};
...
entity OP_API_SALES_ORDER_SRV_0001.A_SlsOrderItemBillingPlanItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
